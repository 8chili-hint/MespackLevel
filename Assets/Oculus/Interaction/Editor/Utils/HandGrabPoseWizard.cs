...
namespace Oculus.Interaction.HandGrab.Editor
{
    ...
    {
        public void SaveToAssetExposed()
        {
            SaveToAsset();
        }
        public void LoadFromAssetExposed()
        {
            LoadFromAsset();
        }

        public HandGrabInteractableDataCollection GetPoseCollection()
        {
            return _posesCollection;
        }

        public void SetPoseCollection(HandGrabInteractableDataCollection collection)
        {
            _posesCollection = collection;
        }
